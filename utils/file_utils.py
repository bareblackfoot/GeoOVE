...
def get_templates(data_dir, targetPOI):
    if targetPOI == "PARIS_BAGUETTE":
        ...
        template_list = [
            ...
            # data_dir + "logo/_cp6.jpg",
            data_dir + "logo/cp6.jpg",
        ] #9.8%
        main_template = data_dir + "logo/cp1.jpg"
        optimal_viewpoint = "06-2-08"
    elif targetPOI == "CU":
        template_list = [
        ...
        optimal_viewpoint = "00-3-08" #12.8%
    else:
    ...
    return templates, main_template, optimal_viewpoint